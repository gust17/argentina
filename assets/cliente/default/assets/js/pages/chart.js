...
function floatchart() {
    ...
    $(function() {
        $("span.pie_1").peity("pie", {
            fill: ["var(--primary)", "#eff3f6"]
        });
        $("span.pie_2").peity("pie", {
            fill: ["#eff3f6", "var(--primary)"]
        });
    ...
    $(function() {
        var options = {
            ...
            colors: ["var(--primary)", "#0e9e4a", "#3ec9d6", "#ffa21d", "#EA4D4D", "#7759de"],
    ...
    $(function() {
        var options = {
            ...
            colors: ["#3ec9d6", "#ffa21d", "var(--primary)"],
        }
