    ...
    setTimeout(function() {
        ...
        $(function() {
            var options = {
                ...
                colors: ["#0e9e4a", "var(--primary)", "#EA4D4D"],
                stroke: {
                    show: true,
                    width: 2,
                    colors: ['transparent']
        ...
        $(function() {
            var options = {
                ...
                colors: ["var(--primary)", "#0e9e4a", "#ffa21d", "#EA4D4D"],
                responsive: [{
                    breakpoint: 480,
                    options: {
                        legend: {
        ...
        $(function() {
            var options = {
                ...
                colors: ["var(--primary)", "#3ec9d6", "#0e9e4a", "#ffa21d", "#EA4D4D"],
                stroke: {
                    width: 1,
                    colors: ['#fff']
                },
        ...
        $(function() {
            var options = {
                ...
                colors: ['#EA4D4D', 'var(--primary)', '#ffa21d'],
                series: [{
                    name: 'Facebook',
                    type: 'column',
        ...
        $(function() {
            var options = {
                ...
                colors: ["var(--primary)", "#0e9e4a", "#EA4D4D", "#ffa21d", "#3ec9d6"],
                series: [{
                    name: "SAMPLE A",
                    data: [
                        [16.4, 5.4],
        ...
        $(function() {
            var options = {
                ...
                colors: ["var(--primary)", "#0e9e4a", "#3ec9d6", "#ffa21d", "#EA4D4D"],
                legend: {
                    show: true,
                    position: 'bottom',
                },
        ...
        $(function() {
            var options = {
                ...
                colors: ["var(--primary)", "#0e9e4a", "#EA4D4D"],
                stroke: {
                    width: 0
                },
                fill: {
