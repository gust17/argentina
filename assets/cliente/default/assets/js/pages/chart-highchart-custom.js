...
$(document).ready(function() {
    ...
    setTimeout(function() {
        Highcharts.chart('chart-highchart-bar1', {
            ...
            colors: ['var(--primary)', '#7759de', '#EA4D4D', '#3ec9d6'],
            title: {
        ...
        Highcharts.chart('chart-highchart-line1', {
            ...
            colors: ['#3ec9d6', 'var(--primary)', '#7759de'],
            title: {
        ...
        Highcharts.chart('chart-highchart-pie1', {
            ...
            colors: ['var(--primary)', '#7759de', '#EA4D4D', '#ffa21d', '#3ec9d6', '#17C666'],
            title: {
        ...
        Highcharts.chart('chart-highchart-combo1', {
            ...
            colors: ['var(--primary)', '#7759de', '#3ec9d6'],
            labels: {
                items: [{
