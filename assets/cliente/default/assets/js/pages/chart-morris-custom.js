...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["var(--primary)", "#7759de", "#17C666"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#ffa21d", "#EA4D4D", "var(--primary)"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#17C666', '#7759de', 'var(--primary)'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#ffa21d', '#EA4D4D', 'var(--primary)'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#ffa21d', '#EA4D4D', 'var(--primary)'],
            lineWidth: 2,
            hideHover: true
        });
