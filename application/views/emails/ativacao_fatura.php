...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #F9F9F9;">
    ...
    <![endif]-->
        ...
        <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
            Olá, sua fatura #<?php echo $id; ?> foi ativada com sucesso.
        </div>
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td style="border-top: 3px solid #e3b15a;background-color:#fff;">
                    <img src="<?php echo base_url(); ?>assets/pages/img/emails/300-ativacao_de_fatura.png" width="300" height="" alt="alt_text" border="0" style="background:#fff;width: 100%; max-width: 300px; height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; margin: auto; display: block;" class="g-img">
                </td>
            </tr>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 20px; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                <h1 style="margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;text-align:center;">Fatura ativada com sucesso!</h1>
                                <p style="margin: 0 0 10px;text-align:center;color:#999;font-size:16px;">
                                    Sua fatura foi ativada com sucesso, confira abaixo os dados de sua ativação: <br /> <br />

                                    <strong>
                                        ID Fatura: #<?php echo $id; ?> <br />
                                        Plano contratado: <?php echo $plano; ?> <br />
                                        Valor: <?php echo MOEDA; ?> <?php echo number_format($valor, 2, ',', '.'); ?> <br />
                                        Ativado em: <?php echo $data_ativacao; ?> <br />
                                        Primeiro Recebimento: <?php echo $data_recebimento; ?> <br />
                                    </strong>
                                </p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 20px; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                <p style="margin: 0 0 10px;text-align:center;color:#999;font-size:11px;">
                                    <em>"A melhor época para plantar uma árvore foi há 20 anos. A segunda melhor é agora"</em> <br /> – Provérbio Chinês.
                                </p>
                            </td>
                        </tr>
                    </table>
