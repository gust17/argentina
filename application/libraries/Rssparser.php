...
class RSSParser {
	...
	function parse()
	{
		...
		if ($xml->channel)
		{
			...
			foreach ($xml->channel->item as $item)
			{
				...
				$data['photo'] = (!empty((string)$item->enclosure['url'])) ? (string)$item->enclosure['url'] : base_url('assets/pages/img/news.jpg');
	...
	function set_aleatory($aleatory = false){
