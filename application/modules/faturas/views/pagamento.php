    ...
    <div class="card">
        ...
        <div class="card-body table-border-style">
            ...
            ?>
                ...
                ?>
                        <a class="btn btn-dark m-t-5" data-toggle="collapse" href="#banco_<?php echo $conta->banco; ?>" role="button" aria-expanded="false" aria-controls="banco_<?php echo $conta->banco; ?>">
                ...
                if ($pixHabilitado == 1) {
                ?>
                    <a class="btn btn-dark m-t-5" data-toggle="collapse" href="#pix" role="button" aria-expanded="false" aria-controls="pix">
                ...
                ?>
                        <a class="btn btn-dark m-t-5" data-toggle="collapse" href="#<?php echo $cryptoValue; ?>" role="button" aria-expanded="false" aria-controls="<?php echo $cryptoName ?>">
                            <?php echo $cryptoName ?>
                        </a>
                <?php
                    }
                ...
                ?>
                    <a class="btn btn-dark m-t-5" data-toggle="collapse" href="#boleto" role="button" aria-expanded="false" aria-controls="Boleto">
                ...
                <a class="btn btn-dark m-t-5" data-toggle="collapse" href="#bpc" role="button" aria-expanded="false" aria-controls="BCP">
                    Banco BBVA (Peru)
                </a>

                <a class="btn btn-dark m-t-5" data-toggle="collapse" href="#bbva" role="button" aria-expanded="false" aria-controls="bbva">
                ...
                <div class="collapse" id="bbva">
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data" id="bbva">
                            ...
                            <button type="submit" name="EnviarComprovante" load-button="on" load-text="<?php echo $this->lang->line('fat_enviando_comprovante_aguarde'); ?>" value="EnviarComprovante" class="btn btn-secondary btn-block"><?php echo $this->lang->line('fat_pagamento_enviar_comprovante_button'); ?></button>
                ...
                <div class="collapse" id="bpc">
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data" id="bcp">
                            ...
                            <div class="table-responsive dt-responsive">
                                Banco BBVA <br />
                                Nombre : Rony Alejandro Camacho Rojas <br />
                                DNI: 74992195 <br />
                                Cuenta : 0011 0814 0229759111 <br />
                                CCI : 011 814 000229759111 13
                            </div>
                ...
                ?>
                        <div class="collapse" id="banco_<?php echo $conta->banco; ?>">
                            <div class="card-body">
                                <form action="" method="post" enctype="multipart/form-data" id="pay_<?php echo $conta->banco; ?>">
                                    ...
                                    <button type="submit" name="EnviarComprovante" load-button="on" load-text="<?php echo $this->lang->line('fat_enviando_comprovante_aguarde'); ?>" value="<?php echo BancoID($conta->banco); ?>" class="btn btn-secondary btn-block"><?php echo $this->lang->line('fat_pagamento_enviar_comprovante_button'); ?></button>
                                    <input type="hidden" name="<?php echo $csrf_name; ?>" value="<?php echo $csrf_hash; ?>" />
                ...
                ?>
                        <div class="collapse" id="<?php echo $cryptoValue; ?>">
                            <div class="card-body">
                                ...
                                <button type="button" name="viaCrypto" value="GerarCarteira" data-crypto="<?php echo $cryptoValue; ?>" class="btn btn-secondary text-uppercase btn-block gerarCarteira"><i data-feather="refresh-cw"></i>&nbsp; <?php echo $this->lang->line('fat_pagamento_via_cripto_gerar_button'); ?></button>
