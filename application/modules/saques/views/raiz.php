<div class="pcoded-content">
    ...
    ?>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body table-border-style">
                        <form action="" method="post" id="sacar_raiz">
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <ul class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        ?>
                                            <li>
                                                <a class="select_account btn btn-secondary mr-2 mb-4" id="v-pills-conta_bancaria-tab" data-toggle="pill" href="#v-pills-conta_bancaria" role="tab" aria-controls="v-pills-conta_bancaria" aria-selected="false" data-account="3">
                                        ...
                                        ?>
                                            <li>
                                                <a class="select_account btn btn-secondary mr-2 mb-4" id="v-pills-carteira_bitcoin-tab" data-toggle="pill" href="#v-pills-carteira_bitcoin" role="tab" aria-controls="v-pills-carteira_bitcoin" aria-selected="false" data-account="4">
                                        ...
                                        ?>
                                            <li>
                                                <a class="select_account btn btn-secondary mr-2 mb-4" id="v-pills-pix-tab" data-toggle="pill" href="#v-pills-pix" role="tab" aria-controls="v-pills-pix" aria-selected="false" data-account="5">
                                                    <?php echo $this->lang->line('saq_tipo_pix'); ?>
                                                </a>
                                            </li>
                                        <?php
                                        }
    ...
    <?php
                ...
                echo alerts($this->lang->line('saq_valor_raiz_nao_existe'), 'danger');
            }
        } else {
...
<?php echo $this->recaptcha->getWidget('sacar_raiz'); ?>