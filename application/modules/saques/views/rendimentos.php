<div class="pcoded-content">
    ...
    ?>
                                ...
                                <div class="swiper-slide" data-slide-bg-color="#071126">
                                    ...
                                    <div class="fashion-slider-title" data-swiper-parallax="-130%">
                                        ...
                                        <div class="fashion-slider-title-text pt-4">
                                            ...
                                            <span class="font-serif"><?php echo MOEDA; ?> <?php echo number_format($saldo_disponivel, 2, ',', '.'); ?></span>
                                            <p>
            ...
            <?php
            if (!$pagamentosTotais) {
                echo alerts($this->lang->line('voltar_primeiro_dia'), 'warning');
            }
            ?>
            ...
            <div class="card">
                ...
                <div class="card-body table-border-style">
                    ...
                    <form action="" method="post" id="sacar_rendimento">
                        <div class="row">
    ...
    <?php
            ...
            echo alerts($this->lang->line('nao_rendeu_plano'), 'danger');
        }
    } else {
...
<?php echo $this->recaptcha->getWidget('sacar_rendimento'); ?>